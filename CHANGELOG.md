...
- German, French, Dutch, Portuguese, and Simplified Chinese README
  translations (`README.de.md`, `README.fr.md`, `README.nl.md`,
  `README.pt.md`, `README.zh.md`), alongside the existing English/Spanish
  pair.
...
- Validator: `unrecognized-junction-type` issue for a Junction whose native
  `type` attribute is neither of the two recognized values.
...
[Unreleased]: https://github.com/ContinuousArchitecture/archi-model-parser/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/ContinuousArchitecture/archi-model-parser/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/ContinuousArchitecture/archi-model-parser/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/ContinuousArchitecture/archi-model-parser/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/ContinuousArchitecture/archi-model-parser/releases/tag/v0.1.0
